...
import SecondHomePage from './component/dashboard/new_components/SecondHomePage.js';
import ContactPage from './component/dashboard/new_components/ContactPage.js';
import HomePage from './component/dashboard/new_components/HomePage.js';
import PortfolioPage from './component/dashboard/new_components/PortfolioPage.js';
import Footer from './component/dashboard/new_components/Footer.js';
import AdminPage from './component/dashboard/new_components/AdminPage.js';
...
const App = () => {
  ...
  const ProtectedRoute = ({ children }) => {
    if (isLoading && !currentUser && localStorage.getItem('currentUser')) { // Still checking initial auth
