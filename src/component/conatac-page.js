        ...
        <div className="contact-content">
          ...
          <div className="social-media-conatact">
            <ul>
              <li>
                <logo>
                  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    x="0px" y="0px" width="122.879px" height="88.855px" viewBox="0 0 122.879 88.855"
                    enableBackground="new 0 0 122.879 88.855" xmlSpace="preserve">
                    <g>
              ...
              <li>
                <logo>
                  <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16.1007 13.359L16.5562 12.9062C17.1858 12.2801 18.1672 12.1515 18.9728 12.5894L20.8833 13.628C22.1102 14.2949 22.3806 15.9295 21.4217 16.883L20.0011 18.2954C19.6399 18.6546 19.1917 18.9171 18.6763 18.9651M4.00289 5.74561C3.96765 5.12559 4.25823 4.56668 4.69185 4.13552L6.26145 2.57483C7.13596 1.70529 8.61028 1.83992 9.37326 2.85908L10.6342 4.54348C11.2507 5.36691 11.1841 6.49484 10.4775 7.19738L10.1907 7.48257" stroke="#1C274C" strokeWidth="1.5" />
                    <path opacity="0.5" d="M18.6763 18.9651C17.0469 19.117 13.0622 18.9492 8.8154 14.7266C4.81076 10.7447 4.09308 7.33182 4.00293 5.74561" stroke="#1C274C" strokeWidth="1.5" />
                    <path opacity="0.5" d="M16.1007 13.3589C16.1007 13.3589 15.0181 14.4353 12.0631 11.4971C9.10807 8.55886 10.1907 7.48242 10.1907 7.48242" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round" />
                  </svg>
                </logo>{" "}
                {phone}
              </li>
              <li>
                <logo>
                  <svg fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512" xmlSpace="preserve">
                    <g>
                ...
                <a href={socials.facebook || "https://www.facebook.com/shreeprashad.das.7"}>Facebook</a>
              </li>
              <li>
                <logo>
                ...
                <a href={socials.linkedin || "https://www.linkedin.com/in/shree-prasad-das-64b9b42ab/"}>LinkedIn</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <form className="contact-form" onSubmit={handleSubmit} noValidate>
          <div className="conatact-form-details">
            <div className="name-details">
              <label htmlFor="name" className="name-label">First Name *</label>
              <input
                type="text"
                className={`cont-name${errors.name ? ' input-error' : ''}`}
                name="name"
                id="name"
                value={form.name}
              ...
              <label htmlFor="middle" className="name-label">Middle Name</label>
              <input
                type="text"
                name="middle"
                id="middle"
              ...
              <label htmlFor="last" className="name-label">Last Name</label>
              <input
                type="text"
                id="last"
                name="last"
            ...
            <div className="other-details">
              <label htmlFor="email" className="other-label">Email *</label>
              <input
                type="email"
                className={`cont-details${errors.email ? ' input-error' : ''}`}
                id="email"
                name="email"
                value={form.email}
                onChange={handleChange}
              ...
              <label htmlFor="phone" className="other-label">Phone No *</label>
              <input
                type="tel"
                className={`cont-details${errors.phone ? ' input-error' : ''}`}
                id="phone"
                name="phone"
                value={form.phone}
                onChange={handleChange}
              ...
              <label htmlFor="adderess" className="other-label">Address</label>
              <input
                type="text"
